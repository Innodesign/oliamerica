...
<div class="row cabeceraNosotros">
    <h3 class="headerNosotros text-center">CONTÁCTANOS</h3>
</div>
<div class="row">
    <div class="col-md-6">
        <h3 class="headerContacto">SU OPINIÓN ES MUY IMPORTANTE PARA NOSOTROS</h3>
        <div class="row">
            <div class="col-12 formContacto">
                ...
                <a href="" class="btnEnviar">ENVIAR <i class="fa fa-paper-plane"></i></a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <h3 class="headerContacto">UBÍCANOS</h3>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-6">
                    <p><strong>Dirección:</strong> Asoc. 1ro de Setiembre Mz 04 Lt 23, CPM AUGUSTO B. LEGUÍA (OFIC.01.SEGUNDO PISO)</p>
                    <p><strong><i class="fa fa-map-marker"></i> TACNA - PERÚ</strong></p>
                </div>
                <div class="col-md-6">
                    <p><strong><i class="fa fa-phone"></i> Teléfono:</strong> 0051-52-314238</p>
