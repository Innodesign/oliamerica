...
return [
    ...
    */
    ...
    'tituloNosotros' => 'CONOCE UN POCO DE NOSOTROS',
    'parrafo1' => 'Somos una empresa  joven del sector agroindustrial  constituida  legalmente en diciembre del año 2009. Estamos ubicados estratégicamente en el extremo sur del Perú, en la provincia de Tacna, que además de ser la principal
        zona productora de olivos cuenta con vías de comunicación adecuadas para facilitar el comercio  exterior.',
    'parrafo2' => 'Nuestros productos  son elaborados bajo Sistemas Internacionales de Calidad garantizados y certificados por
            entidades internacionales, los cuales nos permiten obtener productos de calidad en sus diversas presentaciones.',
    'parrafo3' => 'En OLIAMERICA SAC además de una constante innovación, unimos  la experiencia, honestidad y seriedad en el
    ...
    'objetivo1' => 'Buscar la satisfacción de nuestros clientes en relación a nuestros productos y servicio brindado.',
    'objetivo2' => 'Cumplir  con nuestros clientes  en fecha y  cantidad solicitada  sin errores.',
    'objetivo3' => 'Trabajar con proveedores que cumplan nuestros estándares de calidad en sus productos  para garantizar la
                    calidad e inocuidad de nuestros productos terminados.',
    'objetivo4' => 'Cumplir con los lineamientos establecidos en  nuestros procesos establecidos tanto en el Sistema de
